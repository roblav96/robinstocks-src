...
declare namespace deepstream {
	...
	class RecordHandler {
		...
		setData<T>(name: string, data: T, callback?: (error: string) => void): void
		setData<T>(name: string, path: string, value: T, callback?: (error: string) => void): void
	...
	class Record<T> extends Emitter {
		...
		set<T>(path: string, data: T, callback?: (error: string) => void): void
