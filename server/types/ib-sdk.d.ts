...
declare module 'ib-sdk' {
	...
	export class Account extends NodeJS.EventEmitter {
		accountCode: string
		...
		'dayTradesRemainingT+1': number
		'dayTradesRemainingT+2': number
		'dayTradesRemainingT+3': number
		'dayTradesRemainingT+4': number
